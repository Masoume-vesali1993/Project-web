    ...
    const onGenderChange = value => {
        switch (value) {
            ...
            case 'other':
                ...
                break;
// وقتی که از switch استفاده میکنی باید یه سری نکات ریز رو دقت کنی
// یکی ازین نکات همین استفاده از دیفالت هست ، من مقدار null رو همین طوری گذاشتم
// برای اطلاعات بیشتر در مورد این مورد این لینک رو نگاه کن
// https://www.w3schools.com/js/js_switch.asp
    ...
    // اینجا دوتا تابع هستش که ازشون استفاده ای در کد نمیشه پس بهتره چیزی که استفاده نمیشه توی کد نباشه
