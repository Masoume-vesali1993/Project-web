    ...
    return (
                    ...
                    <Tabs defaultActiveKey="2">
                        <TabPane
                            ...
                            <Collapse accordion>
                                ...
                                <p>در بیمه شخص ثالث، شخص اول شخص بیمه‌گزار (کسی که برای وسیله نقلیه‌ای بیمه شخص ثالث خریداری می‌کند)، شخص ثانی، بیمه‌گر یا شرکت بیمه و شخص ثالث فرد یا افرادی هستند در حادثه رانندگی زیان دیده‌اند به جز راننده مقصر.</p>
                                </Panel>
                                <Panel header="بیمه شخص ثالث برای من چه فایده‌ای دارد؟" key="3">
                                <p>علاوه بر آنکه خرید بیمه شخص ثالث برای تمامی دارندگان وسایل نقلیه موتوری الزامی است، داشتن این بیمه می‌تواند خسارات مالی و جانی ناشی از بروز حادثه را که می‌تواند تا مرز صدها میلیون تومان باشد، جبران نماید.</p>
                                </Panel>
                                <Panel header="خسارت مالی در بیمه شخص ثالث چیست؟" key="4">
                                    <p>خسارت مالی در بیمه شخص ثالث، به معنای خسارتی است که در جریان حادثه به اموال اشخاص ثالث وارد می‌شود.</p>
                                </Panel>
                            </Collapse>
                        </TabPane>
        ...
        <div className="test-slider">
                ...
                <Carousel autoplay>
                    ...
                    <div>
                    <h3>پرهام وصالی</h3>
                    <p>اینکه تو همون روزی که می‌خواستم بیمه‌م رو تمدید کنم تونستم پیشنهادهای شرکت‌های مختلفو با هم مقایسه کنمو همون روز هم بیمه‌م رو تحویل بگیرم خیلی برام جالب بود.</p>
                    </div>
                    <div>
                    <h3>فریبا وصالی</h3>
                    <p>بیمه بدنه خریدم از بیمیتو. اینکه کارشناستون صادقانه تلاش می‌کرد تا بتونم بهترین بیمه بدنه رو بخرم برام خیلی ارزشمند بود.</p>
                    </div>
                    <div>
                    <h3>علیسا زمردی</h3>
                    <p>همیشه دوست داشتم ماشینمو بیمه بدنه کنم اما نمی‌دونستم اصلاً چه خسارتایی رو پوشش می‌ده. خلاصه با سرچ و ... به یکی از مطالب بلاگتون رسیدم که خیلی ساده و کاربردی جواب سؤالامو ‌داد. بعد که دیدم خودتون بیمه هم می‌فروشین دیگه از شما خریدم.</p>
